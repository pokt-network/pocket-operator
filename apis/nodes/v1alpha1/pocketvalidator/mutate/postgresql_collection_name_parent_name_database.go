...
// MutatepostgresqlCollectionNameParentNameDatabase mutates the postgresql resource with name parent.name + -database.
func MutatepostgresqlCollectionNameParentNameDatabase(
	original client.Object,
	parent *nodesv1alpha1.PocketValidator, collection *nodesv1alpha1.PocketSet,
