  ...
  "validators": [
    {
      ...
      "chains": null,
      "generic_param": "` + parent.Name + `-v1-validator1:8080",
    ...
    },
    {
      ...
      "chains": null,
      "generic_param": "` + parent.Name + `-v1-validator2:8080",
      "staked_amount": "1000000000000",
      "paused_height": -1,
      "unstaking_height": -1,
    ...
    },
    {
      ...
      "chains": null,
      "generic_param": "` + parent.Name + `-v1-validator3:8080",
      "staked_amount": "1000000000000",
      "paused_height": -1,
      "unstaking_height": -1,
    ...
    },
    {
      ...
      "chains": null,
      "generic_param": "` + parent.Name + `-v1-validator4:8080",
      "staked_amount": "1000000000000",
      "paused_height": -1,
      "unstaking_height": -1,
